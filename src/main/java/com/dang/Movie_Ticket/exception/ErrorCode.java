...
public enum ErrorCode {
    ...
    DOB_INVALID(1003, "Day of birth must be at least {min}!", HttpStatus.BAD_REQUEST),
    PASSWORD_INVALID(1003, "Password must be at least {min} character!", HttpStatus.BAD_REQUEST),
    THEATER_STATUS_INVALID(1003, "Only update when theater is in maintenance status!", HttpStatus.BAD_REQUEST),
    FOOD_QUANTITY_INVALID(1003, "Insufficient product quantity", HttpStatus.BAD_REQUEST),
    ORDER_SEAT_INVALID(1003, "This seat was booked", HttpStatus.BAD_REQUEST),
    ...
    FOOD_NOT_EXISTED(1005, "Food not existed!", HttpStatus.NOT_FOUND),
